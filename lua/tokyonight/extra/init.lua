...
function M.setup()
  ...
  -- .setup({ plugins = { all = true } })
  for _, extra in ipairs(names) do
    local info = M.extras[extra]
    local plugin = require(".extra." .. extra)
    for style, style_name in pairs(styles) do
      local colors, groups, opts = .load({ style = style, plugins = { all = true } })
      local fname = extra
        ...
        .. "."
        .. info.ext
      colors["_upstream_url"] = "https://github.com/folke/.nvim/raw/main/extras/" .. fname
      colors["_style_name"] = "Tokyo Night" .. style_name
      colors["_name"] = "_" .. style
      colors["_style"] = style
      print("[write] " .. fname)
