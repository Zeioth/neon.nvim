...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("neon-cherry-kiss.hsluv")
    if color ~= "NONE" then
...
---@param groups neon-cherry-kiss.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/neon-cherry-kiss-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, neon-cherry-kiss.Cache
...
---@param key string
---@param data neon-cherry-kiss.Cache
