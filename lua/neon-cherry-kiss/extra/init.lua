...
function M.setup()
  local neon-cherry-kiss = require("neon-cherry-kiss")
  ...
  -- neon-cherry-kiss.setup({ plugins = { all = true } })
  for _, extra in ipairs(names) do
    local info = M.extras[extra]
    local plugin = require("neon-cherry-kiss.extra." .. extra)
    for style, style_name in pairs(styles) do
      local colors, groups, opts = neon-cherry-kiss.load({ style = style, plugins = { all = true } })
      local fname = extra
        ...
        .. "."
        .. info.ext
      colors["_upstream_url"] = "https://github.com/folke/neon-cherry-kiss.nvim/raw/main/extras/" .. fname
      colors["_style_name"] = "Tokyo Night" .. style_name
      colors["_name"] = "neon-cherry-kiss_" .. style
      colors["_style"] = style
      print("[write] " .. fname)
